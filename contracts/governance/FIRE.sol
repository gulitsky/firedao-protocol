...
contract FIRE {
    ...
    function seize(address src, uint256 rawAmount) external onlyOwner {
        ...
        totalSupply = safe96(SafeMath.sub(totalSupply, amount), "FIRE::seize: totalSupply exceeds 96 bits");
    ...
    function permit(
        ...
        require(signatory != address(0), "FIRE::permit: FIREalid signature");
        require(signatory == _owner, "FIRE::permit: unauthorized");
        require(now <= deadline, "FIRE::permit: signature expired");
    ...
    function delegateBySig(
        ...
        bytes32 digest = keccak256(abi.encodePacked("\x19\x01", domainSeparator, structHash));
        address signatory = ecrecover(digest, v, r, s);
        require(signatory != address(0), "FIRE::delegateBySig: FIREalid signature");
        require(nonce == nonces[signatory]++, "FIRE::delegateBySig: FIREalid nonce");
